  ...
  return (
    ...
    <>
      ...
      <div className=" grid gap-4 justify-items-center justify-center text-center mt-20">
        ...
        <input type="email" id="email" name="email" placeholder="Email Address" className=" shadow-xl border rounded-xl w-96 h-7 bg-transparent text-white border-orange-500 text-left pl-3" />
        <input type="password" id="password" name="password" placeholder="Password" className=" shadow-xl border rounded-xl w-96 h-7 bg-transparent text-white border-orange-500 text-left pl-3" />
