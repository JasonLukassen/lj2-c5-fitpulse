        ...
        <>
            ...
            <div className=" min-h-screen flex justify-center items-center">
                ...
                <div className="text-center">
                    <h1 class="font-poppins text-white text-3xl md:text-5xl font-semibold mb-8 transition-colors duration-2000 ease-in-out animate-color-change">Register.</h1>
                    ...
                    <div className="grid gap-4 justify-items-center">
                        ...
                        <button className="w-64 md:w-80 h-9 text-white font-poppins font-semibold rounded-xl border-gradient bg-gradient-to-r from-yellow-500 via-orange-400 to-orange-300 mt-4 transition duration-300 ease-in-out transform hover:scale-105"><Link to="/">Create account.</Link></button>
