    ...
    return (
        <>
            ...
            <div className=" min-h-screen flex justify-center items-center">
                {/* <img src={greyCircle} alt="grey circle" className="absolute top-0 right-0 z-0 hidden md:block" />
        <img src={orangeCircle} alt="orange circle" className="absolute top-0 right-0 z-0 hidden md:block" /> */}

                <div className="text-center">
                    <h1 className="font-poppins text-white text-3xl md:text-5xl font-semibold mb-8">Register.</h1>
                    ...
                    <div className="grid gap-4 justify-items-center">
                        ...
                        <button className="w-64 md:w-80 h-9 text-white font-poppins font-semibold rounded-xl border-gradient bg-gradient-to-r from-yellow-500 via-orange-400 to-orange-300 mt-4 transition duration-300 ease-in-out transform hover:scale-105">Create Account.</button>
